...
public class DialogoSeleccionarCompanero extends JDialog implements ActionListener{
    ...
    * @param pPrincipal
    */
   public DialogoSeleccionarCompanero (InterfazTetris pPrincipal, String[] jugadores){
